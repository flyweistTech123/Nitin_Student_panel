            ...
            <Popover.Body className='template40'>
                <div className='template38'>
                    <div className='template39'>
                        <p onClick={()=>navigate('/actionWatiTemplateselect')}>First Name</p>
                        <p>Last Name</p>
                        <p>Email ID</p>
                        <p>ID</p>
                        <p>Admission No.</p>
        ...
        <>
            <div className='template20'>
                <div className='template21'>
                    <IoArrowBackOutline size={25} onClick={() => navigate('/watitemplate')} />
                    <h6>Wati Template</h6>
                </div>
...
export default ActionWatiTemplate