                ...
                <Modal.Body >
                    <div className='newpaymentrequest1'>
                        ...
                        <div className='newpaymentrequest3'>
                            ...
                            <div className='newpaymentrequest4'>
                                <label htmlFor="">Select Student Request Type</label>
                                <select name="" id="">
                                    <option value="">Lorem Ipsum Student Req. Type</option>
                                    <option value="">Lorem Ipsum Student Req. Type</option>
                                    <option value="">Lorem Ipsum Student Req. Type</option>
                                    <option value="">Lorem Ipsum Student Req. Type</option>
                                    <option value="">Lorem Ipsum Student Req. Type</option>
        ...
        <>
            ...
            <div className='payfeepayfee8'>
                <div className='referenceformdata2'>
                    <button style={{ backgroundColor: "#2155CD" }} onClick={() => setModalShow(true)}>ADD REQUEST</button>
                </div>
